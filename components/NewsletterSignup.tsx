  ...
  return (
    <div className="bg-gradient-to-br from-[#2C221E] to-[#42342E] text-[#FAF6F0] rounded-3xl p-8 sm:p-12 shadow-xl relative overflow-hidden my-12 border border-[#D99B26]/20">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        {status === 'success' ? (
          <div className="bg-[#D99B26]/20 border border-[#D99B26] rounded-2xl p-6 text-center animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
            <input
              ...
              className="px-4 py-3.5 bg-white/10 border border-[#FAF6F0]/20 rounded-xl sm:rounded-full text-[#FAF6F0] placeholder-[#FAF6F0]/50 text-sm focus:outline-none focus:border-[#D99B26] transition-colors w-full sm:w-1/3"
            />
            <input
              type="email"
              required
              ...
              className="px-5 py-3.5 bg-white/10 border border-[#FAF6F0]/20 rounded-xl sm:rounded-full text-[#FAF6F0] placeholder-[#FAF6F0]/50 text-sm focus:outline-none focus:border-[#D99B26] transition-colors w-full sm:w-2/3"
            />
            <button
              type="submit"
              disabled={status === 'loading'}
              className="px-7 py-3.5 bg-[#D99B26] hover:bg-[#c28a21] text-[#2C221E] font-semibold text-sm rounded-xl sm:rounded-full transition-all duration-200 transform hover:-translate-y-0.5 shadow-md cursor-pointer whitespace-nowrap disabled:opacity-50"
            >
        ...
        {status === 'error' && (
          <p className="text-xs text-[#A83226] mt-3 font-semibold">
            {errorMessage}
          </p>
        )}
      </div>
